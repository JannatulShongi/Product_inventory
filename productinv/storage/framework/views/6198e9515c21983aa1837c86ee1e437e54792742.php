    ...
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <h1 style="color: #EF3B2D"><a href="/">Product Inventory</a></h1>
            </div>
                                ...
                                <div class="p-6">
                                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                        <form action="#" method="POST">
                                            ...
                                            <div class="form-group row">
                                                <label for="unit"
                                                    class="col-md-4 col-form-label text-md-right">Unit</label>
                                                <div class="col-md-6">
                                                    <input id="unit" type="text" class="form-control"
                                                        name="unit" required autofocus>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="quantity"
...
<script>
    var tabledata = $('#table-data').DataTable({
        // processing: true,
        serverSide: true,
        ajax: "<?php echo e(url('/products/productslist/datatable')); ?>",
        "order": [
            [0, 'asc']
        ],
        columns: [{
...
<?php /**PATH C:\Users\Samir Raihan\Desktop\New folder\test\productinv\resources\views/products/index.blade.php ENDPATH**/ ?>